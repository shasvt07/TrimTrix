...
const ShopUpdate = ({navigation}) => {
  ...
  const initialStates = {
    ...
    hair: {cost: myShop?.hair?.cost, time: myShop?.hair?.time},
    beard: {cost: myShop?.beard?.cost, time: myShop?.beard?.time},
    lobby: myShop?.lobby,
  };
    ...
    <ScrollView style={[tw`bg-white`]}>
      <View style={styles.container}>
          ...
          <View style={styles.smallconatiner}>
            ...
            <View style={tw`border-gray-300 border-2 w-full m-4 rounded-full`}>
              <TextInput
                ...
                value={shopData.current.phoneNumber}
              />
            </View>
          </View>
            ...
            <View
              ...
              <TextInput
                ...
                onChangeText={e =>
                  (shopData.current = {
                    ...shopData.current,
                    location: {...shopData.current.location, address: e},
                  })
                }
              />
              <TouchableHighlight
        ...
        {mapOpen && (
          <View
            style={[
              tw`m-4 absolute z-50 border-black border-2`,
              {height: '60%', width: '90%'},
            ]}>
            <Ionicons
              size={24}
          ...
          <View style={styles.servicesItems}>
            <View style={styles.haircutting}>
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <View
                  ...
                  <TextInput
                    value={shopData.current?.hair?.cost.toString()}
                    placeholder="₹ 0.0"
                    style={tw`ml-2`}
                    keyboardType="number-pad"
                    onChangeText={e =>
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <View style={tw`border-gray-300 border-2 w-28 rounded-3xl m-2`}>
                  <TextInput
                    ...
                    style={tw`ml-2`}
                    keyboardType="number-pad"
                    value={shopData.current?.hair?.time.toString()}
                    onChangeText={e =>
                      (shopData.current = {
                        ...shopData.current,
            ...
            <View style={styles.beard}>
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <View style={tw`border-gray-300 border-2 w-28 rounded-3xl m-2`}>
                  <TextInput
                    value={shopData.current?.beard?.cost.toString()}
                    placeholder="₹ 0.0"
                    style={tw`ml-2`}
                    keyboardType="number-pad"
                    onChangeText={e =>
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <View style={tw`border-gray-300 border-2 w-28 rounded-3xl m-2`}>
                  <TextInput
                    ...
                    style={tw`ml-2`}
                    keyboardType="number-pad"
                    value={shopData.current?.beard?.time.toString()}
                    onChangeText={e =>
                      (shopData.current = {
                        ...shopData.current,
